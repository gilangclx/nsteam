...
echo color("green","* Time : ".date('[d-m-Y] [H:i:s]')." \n");
	...
	gocar:
        ...
        $code1 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADI6"}');
        $message = fetch_value($code1,'"message":"','"');
        echo "\n".color("white"," Message: ".$message);
        echo "\n".color("white"," REFRESH..");
        echo "\n".color("white"," Please wait");
        ...
        sleep(3);
        $boba09 = request('/go-promotions/v1/promotions/enrollments', $token, '{"promo_code":"HARIJADI5"}');
